...
LABEL org.opencontainers.image.title="stalwart-fdb" \
      org.opencontainers.image.description="Official Stalwart FoundationDB binary with a verified non-AVX FoundationDB client" \
      org.opencontainers.image.source="https://github.com/MK796/stalwart-fdb" \
      org.opencontainers.image.vendor="MK796" \
      org.opencontainers.image.version="${STALWART_VERSION}-fdb${FDB_VERSION}" \
